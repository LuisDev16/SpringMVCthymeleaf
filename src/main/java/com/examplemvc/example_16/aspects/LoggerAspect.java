package com.examplemvc.example_16.aspects;
...
public class LoggerAspect {
    @Around("execution(* com.examplemvc.example_16..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.examplemvc.example_16..*.*(..))",throwing = "ex")
